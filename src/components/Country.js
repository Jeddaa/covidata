      ...
      <div className="cursor-pointer border-solid border-2 border-stone-400">
        {imageSrc && (
          <div className="relative p-1">
            ...
            <div className="absolute flex inset-0 bg-stone-500 opacity-50 justify-between items-end pr-1">
              <p className=" pl-1 m-0 text-base sm:text-lg lg:text-2xl text-white">{total}</p>
              <h1 className="text-white text-end text-base sm:text-lg lg:text-3xl leading-none font-bold">{Country}</h1>
            </div>
          </div>
        )}
      </div>
